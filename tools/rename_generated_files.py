...
def infer_model_from_sequence(eval_timestamp_to_od: Dict[str, str]) -> Dict[str, str]:
    ...
    model_sequence = [
        'vanilla', 'vanilla',
        'vanilla_seed43', 'vanilla_seed43',
        'vanilla_seed44', 'vanilla_seed44',
        'distill', 'distill',
        'distill_seed43', 'distill_seed43',
        'distill_seed44', 'distill_seed44',
    ]
...
def main():
    if len(sys.argv) < 2:
        print("Usage: uv run python tools/rename_generated_files.py <eval-dir> [--dry-run]")
        print("\nExample:")
        print("  uv run python tools/rename_generated_files.py hoser-distill-optuna-porto-eval-eb0e88ab-20251026_152732")
        sys.exit(1)
