...
def plot_all(data: Dict, output_dir: Path, dpi: int = 300, loader=None):
    ...
    plot_application_radars(data, output_dir, dpi, loader=loader)

    # Generate both individual and grid heatmaps
    plot_improvement_heatmaps_individual(data, output_dir, dpi, loader=loader)
    plot_improvement_heatmap_grid(data, output_dir, dpi, loader=loader)


def plot_application_radars(data: Dict, output_dir: Path, dpi: int, loader=None):
...
def plot_improvement_heatmaps_individual(
    data: Dict, output_dir: Path, dpi: int, loader=None
):
...
def plot_improvement_heatmap_grid(data: Dict, output_dir: Path, dpi: int, loader=None):
...
def plot_improvement_heatmap(data: Dict, output_dir: Path, dpi: int, loader=None):
